...
const szukaniesprawdzania = document.getElementById("sprawdzanie");
...
szukanieprzycisku.addEventListener('click', function (){
    ...
    console.log(liczba);
    if(liczba>=20){
        szukaniesprawdzania.innerText='Wylosowana liczba jest większa lub równa 20'
    }else {
        szukaniesprawdzania.innerText=''
    }
    if(liczba % 2 ===0){
        parzysta.innerText='Wylosowana liczba jest parzysta'
    }else {
        parzysta.innerText='Wylosowana liczba jest nieparzysta'
    }
    if(liczba<=9){
